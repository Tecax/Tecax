...
This mechanism has been integrated into Bitcore-Node-Tecax which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tecaxpay/insight-api-tecax#web-socket-api](https://github.com/tecaxpay/insight-api-tecax#web-socket-api)
* API: [https://github.com/tecaxpay/insight-api-tecax#instantsend-transactions](https://github.com/tecaxpay/insight-api-tecax#instantsend-transactions)
...
By default, the Tecax Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Tecax Core daemon:
