    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TECAX-light"), QVariant("light"));
    ui->theme->addItem(QString("TECAX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("TECAX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TECAX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TECAX-traditional"), QVariant("trad"));
