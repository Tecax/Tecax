    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Tecax Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tecax address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tecax: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Tecax Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tecax Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tecax Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tecax addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tecax addresses"));
    ...
    openAction->setStatusTip(tr("Open a tecax: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tecax Core help message to get a list with possible Tecax Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Tecax Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tecax network", "", count));
    } else {
...
{
    QString strTitle = tr("Tecax Core"); // default title
