    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Tecax Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Tecax Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  tecax-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Tecax in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TECAX, 0.1 TECAX, 1 TECAX and 10 TECAX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://tecaxpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://tecaxpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Tecax Core is shutting down...") + "<br /><br />" +
