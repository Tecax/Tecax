...
#define BOOST_TEST_MODULE Tecax Test Suite

#include "test_tecax.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_tecax_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
