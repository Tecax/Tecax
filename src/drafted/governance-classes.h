 ...
 *
 *   // network
 *   CTecaxNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.tecax.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTecaxNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: TecaxNetwork
// //   -- signature requirements : Key1(User)
// class CTecaxNetworkVariable : public CGovernanceObject
// {
// private:
