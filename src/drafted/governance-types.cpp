...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TecaxNetwork") type = TecaxNetwork;
    if(strType == "TecaxNetworkVariable") type = TecaxNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TecaxNetwork) s = "TecaxNetwork";
    if(type == TecaxNetworkVariable) s = "TecaxNetworkVariable";
