...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Tecax related functionality
...
/*
    ...
    allow endless transaction that would bloat Tecax and make it unusable. To
